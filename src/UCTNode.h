...
public:
    ...
    bool create_children(Network & network, Network & network_aux,
    ...
    UCTNode* uct_select_child(int color, bool is_root, bool is_hp=true);
    UCTNode* ladder_select_child(int color, bool is_root, bool is_hp, int m);
    ...
    void prepare_root_node(Network & network, Network & network_aux, int color,
                           std::atomic<int>& nodecount,
                           GameState& state);
